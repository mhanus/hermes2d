...
void TikZGraph::save(const char* filename)
{
  int j;
  ...
  fprintf(f, "set term tikz size %g,%g nopicenvironment\n", this->w, this->h);
  ...
  verbose("Graph saved. Process '%s' via gnuplot. Then in LaTeX preamble: \n\t\\usepackage{gnuplot-lua-tikz}.\n After that, say\n\t \\begin{tikzpicture}[gnuplot]\n\t   \input{%s.tikz}\n\t \\end{tikzpicture] to typeset the figure.", filename, outname);
}
